...
Boko with date/time as filename
"""
...
def main():
    ...
    parser.add_argument('-u', '--url', help='Base URL to use', type=str, default='http://192.168.2.84')
    parser.add_argument('-o', '--output', help='Output filename', type=str, default=datetime.datetime.now().strftime("%Y_%m_%d_%H_%M_%S") + '.gpx')
