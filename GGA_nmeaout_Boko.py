...
def main():
    ...
    parser.add_argument('-u', '--url', help='IP/URL of Underwater GPS kit. Typically http://192.168.2.94', type=str, default='http://192.168.2.94')
    # UDP options
    ...
    while True:
        ...
        if pos:
            ...
            sentence = gen_gga(time.gmtime(), pos["lat"], pos["lon"], 2, 12, 0.9, 0, 0)
            print(sentence)
            if sock:
